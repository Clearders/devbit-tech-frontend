...
/* texmath wrapper elements (generated by markdown-it-texmath) */
.markdown-renderer :deep(eq) {
  display: inline-block;
}

.markdown-renderer :deep(eqn) {
  display: block;
}

.markdown-renderer :deep(section.eqno) {
  display: flex;
  flex-direction: row;
...
.markdown-renderer :deep(section.eqno > eqn) {
  width: 100%;
  margin-left: 3em;
}

.markdown-renderer :deep(section.eqno > span) {
  width: 3em;
  text-align: right;
}
